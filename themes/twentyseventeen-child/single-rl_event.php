...
<div class="wrap">
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<span class="meta">
				<p>When: <?php echo get_post_meta( $post->ID , 'ev_date', true ); ; ?><br>
				Where: <?php echo get_post_meta( $post->ID , 'ev_location', true ); ; ?> <br>
				RSVP: <?php echo get_post_meta( $post->ID , 'ev_link', true ); ; ?></p>
			...
			while ( have_posts() ) :
				...
				echo get_post_meta( $post->ID , 'ev_date', true );
				echo get_post_meta( $post->ID , 'ev_location', true );
				echo get_post_meta( $post->ID , 'ev_link', true );
